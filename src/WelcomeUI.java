...
public class WelcomeUI extends JFrame {
    ...
    public WelcomeUI() {
        ...
        ImageIcon originalIcon = new ImageIcon("C:\\Users\\User\\Downloads\\mi (4).png");
        Image img = originalIcon.getImage();

        // Optionally scale the image to fit partially but keep proportions
        int frameWidth = 1920;
        ...
        double ratio = Math.min(widthRatio, heightRatio) * 0.8; // 80% of frame
        ...
        background.setLayout(null); // important for absolute positioning
